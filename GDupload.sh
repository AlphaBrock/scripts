...
# downloadpath='/data/wwwroot/pan.alphabrock.cn' #下载目录
# rclone='/data/wwwroot/pan.alphabrock.cn/GoogleDrive'   #rclone挂载的目录
...
RemoteDIR="/data/wwwroot/pan.alphabrock.cn/GoogleDrive/";  #rclone挂载的本地文件夹，最后面保留/
LocalDIR="/data/wwwroot/pan.alphabrock.cn/";  #Aria2下载目录，最后面保留/
